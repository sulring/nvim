return function(client, bufnr)
	...
	if client.name == "typescript-tools" then
		-- Import management
		keymap("n", "<leader>co", "<cmd>TSToolsOrganizeImports<cr>", { desc = "Organize Imports", buffer = bufnr })
		keymap("n", "<leader>cs", "<cmd>TSToolsSortImports<cr>", { desc = "Sort Imports", buffer = bufnr })
		keymap(
			"n",
			"<leader>cu",
		...
		-- Code management
		keymap("n", "<leader>cU", "<cmd>TSToolsRemoveUnused<cr>", { desc = "Remove Unused Statements", buffer = bufnr })
		keymap("n", "<leader>ci", "<cmd>TSToolsAddMissingImports<cr>", { desc = "Add Missing Imports", buffer = bufnr })
		keymap("n", "<leader>cf", "<cmd>TSToolsFixAll<cr>", { desc = "Fix All", buffer = bufnr })
		...
		keymap("n", "<leader>cR", "<cmd>TSToolsRenameFile<cr>", { desc = "Rename File", buffer = bufnr })
		keymap("n", "<leader>cr", "<cmd>TSToolsFileReferences<cr>", { desc = "File References", buffer = bufnr })
	end
end
